...
- [Switch HID Core](switch-hid-core.md): `0x30` input report、`0x21` subcommand reply、output report parser、virtual SPI、rumble、player lights、scheduler priority policy、production send path と実機観測境界。
