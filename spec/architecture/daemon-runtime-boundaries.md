...
- stable IPC metrics / status protocol の unavailable-state schema は `work-units/complete/local_039/DAEMON_STATUS_OBSERVABILITY_PROTOCOL.md` で完了した。実機由来の measured adapter / driver / report rate / jitter 値を追加公開する場合は後続 work unit で扱う。
