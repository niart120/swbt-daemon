...
- `spec/architecture/daemon-architecture-cutover.md` は application、IPC、BTstack adapter、daemon host の current boundary として、BTstack 関連 reference と完了済み work unit record を参照する。
