...
| production adapter location selector is required before adapter open | implementation fact / source audit | `work-units/complete/local_077/ADAPTER_SELECTOR_GUARD.md`, `swbt/btstack_bridge/production_btstack_impl.c`, `cmake/btstack_winusb_location_patch.cmake` | current software gate; Windows native location value still requires preflight record |
