...
**対象外** は、この work unit の完了条件に含めない境界である。対象外は未完了ではない。後続 work unit の source として扱う具体的な観測、判断材料、次の置き場があるものは、対象外ではなく先送り事項に置く。
...
対象外と先送り事項を迷った場合は、後で作業を起こすための source になっているかで判断する。後続作業の観測、候補、判断軸、次の置き場が書けるなら先送り事項に置く。それらがなく、この work unit の境界を示すだけなら対象外に置く。
