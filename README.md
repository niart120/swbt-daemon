...
| architecture cutover | `swbt_app_t`、`swbt_daemon_host_t`、`swbt_btstack_production_adapter_t` を唯一の実装経路にし、旧 session、mailbox、runtime、production backend ops、`swbt_core` を削除済み。 | `spec/architecture/daemon-architecture-cutover.md`, `work-units/complete/local_056/ARCHITECTURE_CUTOVER.md` |
