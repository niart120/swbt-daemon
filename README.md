...
| neutral fail-safe | owner disconnect、heartbeat timeout、shutdown で neutral report へ戻ることを実機観測済み。 | `docs/hardware-test-log.md` |
...
| `SWBT_DEVICE_INFO_PROFILE` | 例: `mizuyoukanao-pro` | 既知の Switch 2 bring-up 実行で使った device info profile。正規 identity として固定した値ではない。 |
