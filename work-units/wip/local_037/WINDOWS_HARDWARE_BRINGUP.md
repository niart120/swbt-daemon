...
- shutdown 時に非 neutral owner が残っている場合の明示的な neutral 観測。理由は、owner disconnect rerun では owner socket close 後に neutral 化してから手動停止しているためである。
...
- [ ] shutdown 時の非 neutral fail-safe を明示的に記録した。
