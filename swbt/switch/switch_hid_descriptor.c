...
static const uint8_t k_switch_hid_descriptor[SWBT_SWITCH_HID_DESCRIPTOR_SIZE] = {
...
_Static_assert(sizeof(k_switch_hid_descriptor) == SWBT_SWITCH_HID_DESCRIPTOR_SIZE,
               "Switch HID descriptor size drifted");

const uint8_t *swbt_switch_hid_descriptor_data(void) {
    return k_switch_hid_descriptor;
}

size_t swbt_switch_hid_descriptor_size(void) {
    return sizeof(k_switch_hid_descriptor);
}
