#ifndef SWBT_DAEMON_PRODUCTION_RECONNECT_H
#define SWBT_DAEMON_PRODUCTION_RECONNECT_H
...
typedef enum {
    SWBT_DAEMON_PRODUCTION_RECONNECT_REQUEST_INVALID = -1,
    SWBT_DAEMON_PRODUCTION_RECONNECT_REQUEST_READY = 0,
    SWBT_DAEMON_PRODUCTION_RECONNECT_REQUEST_NONE = 1,
...
typedef struct {
    ...
    swbt_domain_t *app;
} swbt_daemon_production_reconnect_t;
