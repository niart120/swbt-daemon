#ifndef SWBT_DAEMON_PRODUCTION_SHUTDOWN_H
#define SWBT_DAEMON_PRODUCTION_SHUTDOWN_H
...
typedef struct {
    ...
    swbt_daemon_production_shutdown_finish_t finish;
    void *finish_context;
...
} swbt_daemon_production_shutdown_t;
