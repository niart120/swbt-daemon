...
static swbt_control_result_t swbt_control_map_app_result(swbt_domain_result_t result) {
    switch (result) {
    case SWBT_DOMAIN_OK:
    case SWBT_DOMAIN_ERROR_STALE_SEQUENCE:
        return SWBT_CONTROL_OK;
    case SWBT_DOMAIN_ERROR_OWNER_BUSY:
        return SWBT_CONTROL_ERROR_OWNER_BUSY;
    case SWBT_DOMAIN_ERROR_NOT_OWNER:
        return SWBT_CONTROL_ERROR_NOT_OWNER;
    case SWBT_DOMAIN_ERROR_INVALID_ARGUMENT:
...
swbt_control_result_t swbt_control_acquire_client(swbt_control_t *control, uint32_t client_id) {
    ...
    return swbt_control_map_app_result(swbt_domain_acquire(control->app, client_id));
}
...
swbt_control_result_t swbt_control_release_client(swbt_control_t *control, uint32_t client_id) {
    ...
    return swbt_control_map_app_result(
        swbt_domain_revoke(control->app, (swbt_domain_revoke_options_t){
                                             .reason = SWBT_DOMAIN_REVOKE_RELEASE,
                                             .client_id = client_id,
                                         }));
}
...
swbt_control_result_t swbt_control_disconnect_client(swbt_control_t *control, uint32_t client_id) {
    ...
    return swbt_control_map_app_result(
        swbt_domain_revoke(control->app, (swbt_domain_revoke_options_t){
                                             .reason = SWBT_DOMAIN_REVOKE_DISCONNECT,
                                             .client_id = client_id,
                                         }));
}
...
swbt_control_result_t swbt_control_heartbeat_timeout_client(swbt_control_t *control,
    ...
    return swbt_control_map_app_result(
        swbt_domain_revoke(control->app, (swbt_domain_revoke_options_t){
                                             .reason = SWBT_DOMAIN_REVOKE_HEARTBEAT_TIMEOUT,
                                             .client_id = client_id,
                                         }));
}
...
swbt_control_result_t swbt_control_record_state_update_rejected(swbt_control_t *control) {
    ...
    return swbt_control_map_app_result(swbt_domain_record_state_update_rejected(control->app));
}
...
swbt_control_result_t swbt_control_submit_client_state(swbt_control_t *control, uint32_t client_id,
    ...
    return swbt_control_map_app_result(
        swbt_domain_set_state(control->app, (swbt_domain_set_state_options_t){
                                                .client_id = client_id,
                                                .state = state,
                                                .sequence = sequence,
                                            }));
...
swbt_control_result_t swbt_control_submit_state(swbt_control_t *control,
    ...
    const swbt_control_result_t acquire_result = swbt_control_map_app_result(
        swbt_domain_acquire(control->app, swbt_control_direct_client_id));
